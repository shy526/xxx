 	...
 	<%@include file="/First_Header.jsp"%>
                        ...
                        <div class="product_sidebar_widget_inner">
                            <div class="s_widget s_widget_categories">
                               <div class="s_widget_tittle">
                                ...
                                <ul>
                                    <li><a href="#"><i class="lnr lnr-user"></i>全部 商品</a></li>
                                    <li><a href="#"><i class="lnr lnr-shirt"></i>服装 服饰</a></li>
                                    <li><a href="#"><i class="lnr lnr-phone"></i>手机数码</a></li>
                                    <li><a href="#"><i class="lnr lnr-printer"></i>家用电器</a></li>
                                    <li><a href="#"><i class="lnr lnr-file-empty"></i>图书杂志</a></li>
                                    <li><a href="#"><i class="lnr lnr-star"></i>汽车用品</a></li>
                                    <li><a href="#"><i class="lnr lnr-apartment"></i>理财产品</a></li>
                                    <li><a href="#"><i class="lnr lnr-mustache"></i>食品饮料</a></li>
                                </ul>
                            </div>
        ...
        <footer class="footer_area footer_style2">
            ...
            <div class="copyright_footer">
                <h4>Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></h4>
            </div>
        </footer>
        <!--==========End Footer area==========-->
