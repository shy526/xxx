...
<div >
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd" >
				<a href="${app}/ProdListServlet" target="fname">商品列表</a>
			</dd>
			<dd>	<a target="fname" href="${app}/back/product_add.jsp">添加商品</a></dd>

			<%--<dd><a href="${app}/back/product_list.jsp">商品列表</a></dd>--%>
			<%--<!--<dd><a href="#">消费记录</a></dd>-->--%>
			<dd><a href="#">操作记录</a></dd>
		</dl>
...
<div class="fdiv">
 <iframe name="fname" src="text.html" class="fname"></iframe>
</div>
